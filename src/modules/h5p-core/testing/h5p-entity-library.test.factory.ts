...
import { InstalledLibraryEntity } from '../repo';

type InstalledLibraryProperties = InstalledLibraryEntity;

class H5PEntityLibraryTestFactory extends BaseFactory<InstalledLibraryEntity, InstalledLibraryProperties> {}

export const h5pEntityLibraryTestFactory = H5PEntityLibraryTestFactory.define(
	InstalledLibraryEntity,
	({ sequence }) => {
